...
import { Brain, Workflow, Zap, ArrowRight, Clock, Users, RefreshCcw, Database, Mail, FileSpreadsheet, MessageSquare, Settings, CheckCircle2, Layers, BarChart3, Sparkles, Target, Puzzle, Handshake, Search, TrendingUp, Cog, Eye, Wrench } from "lucide-react";
...
export default function AiAutomatizacija() {
  ...
  const manualProblems = [{
    icon: Clock,
    text: t("Stundas pavadītas atkārtojošos uzdevumos", "Hours spent on repetitive tasks")
  }, {
    icon: Users,
    text: t("Cilvēki dara robotu darbu", "People doing robot work")
  }, {
    icon: RefreshCcw,
    text: t("Tie paši procesi katru dienu", "The same processes every day")
  }, {
    icon: Database,
    text: t("Dati, kas jāpārvieto manuāli", "Data that needs to be moved manually")
  }];
  ...
  const benefits = [t("Ietaupiet 10+ stundas nedēļā", "Save 10+ hours per week"), t("Samaziniet cilvēciskās kļūdas", "Reduce human errors"), t("Ātrāka reakcija uz klientiem", "Faster response to clients"), t("Skaidra datu plūsma", "Clear data flow"), t("Mērogojamība bez papildu resursiem", "Scalability without additional resources"), t("Focus uz stratēģisku darbu", "Focus on strategic work")];

  // System nodes for hero visual
  const systemNodes = [{
    id: "input",
    icon: Zap,
    label: t("Trigeris", "Trigger"),
    x: 10,
    y: 50
  }, {
    id: "process",
  ...
  return <div className="overflow-hidden">
      ...
      <section className="relative min-h-[75vh] sm:min-h-[85vh] md:min-h-[90vh] flex items-center overflow-hidden py-8 sm:py-0">
        ...
        <motion.div className="absolute top-10 sm:top-20 right-[5%] sm:right-[15%] w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 rounded-full bg-primary/10 blur-2xl sm:blur-3xl" animate={{
        scale: [1, 1.2, 1],
        opacity: [0.3, 0.5, 0.3]
      }} transition={{
        duration: 8,
        ...
        <motion.div className="absolute bottom-10 sm:bottom-20 left-[5%] sm:left-[10%] w-40 sm:w-64 md:w-80 h-40 sm:h-64 md:h-80 rounded-full bg-primary/15 blur-2xl sm:blur-3xl" animate={{
        scale: [1.1, 1, 1.1],
        opacity: [0.4, 0.2, 0.4]
      }} transition={{
        duration: 6,
        ...
        <div className="container-neo section-padding relative z-10 px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <ScrollReveal>
                <span className="chip-outline mb-4 sm:mb-6 md:mb-8 inline-block text-xs sm:text-sm my-[50px]">
              ...
              <ScrollReveal delay={0.2}>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-4xl mx-auto mb-6 sm:mb-8 md:mb-12 px-2 sm:px-4">
                  {t("Pārbaudīti mākslīgā intelekta risinājumi, kas palīdz uzņēmumiem sakārtot procesus, samazināt manuālo darbu un strādāt efektīvāk", "Proven artificial intelligence solutions that help businesses organize processes, reduce manual work, and work more efficiently")}
                </p>
              </ScrollReveal>
              ...
              <div className="relative max-w-5xl mx-auto">
                <div className="bg-card/90 backdrop-blur-md rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-10 lg:p-12 border border-border shadow-neo-lg">
                    ...
                    <div className="flex items-center justify-between max-w-2xl mx-auto px-2 sm:px-4">
                      ...
                      type: "spring"
                        ...
                        <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-xl sm:rounded-2xl bg-primary/15 flex items-center justify-center relative">
                          ...
                          <motion.div className="absolute inset-0 rounded-xl sm:rounded-2xl border-2 border-primary/30" animate={{
                          scale: [1, 1.1, 1],
                          opacity: [0.5, 0, 0.5]
                        }} transition={{
                          duration: 2,
                  ...
                  <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-6">
                    {[{
                    label: t("Automatizēti procesi", "Automated processes"),
                    value: "85%",
                    icon: Workflow
                  }, {
                    label: t("Ietaupīts laiks nedēļā", "Saved time per week"),
                    value: "10h+",
                    icon: Clock
                  }, {
                    label: t("Uzlabota efektivitāte", "Improved efficiency"),
                    value: "3x",
                    icon: Zap
                    ...
                    <div className="flex items-center justify-between gap-2 md:gap-4">
                      ...
                      label: "Rezultāts"
                        ...
                        delay: 0.5 + i * 0.1
                          ...
                          {i < 3 && <motion.div className="absolute hidden md:block" style={{
      ...
      <section className="relative py-14 sm:py-20 md:py-32 overflow-hidden">
        ...
        <motion.div className="absolute top-0 left-[10%] sm:left-1/4 w-[250px] sm:w-[400px] md:w-[500px] h-[250px] sm:h-[400px] md:h-[500px] rounded-full bg-gradient-to-br from-primary/20 to-amber-300/20 blur-2xl sm:blur-3xl" animate={{
        scale: [1, 1.2, 1],
        x: [0, 30, 0],
        opacity: [0.4, 0.6, 0.4]
      }} transition={{
        ...
        <motion.div className="absolute bottom-0 right-[10%] sm:right-1/4 w-[200px] sm:w-[300px] md:w-[400px] h-[200px] sm:h-[300px] md:h-[400px] rounded-full bg-gradient-to-br from-amber-200/30 to-primary/15 blur-2xl sm:blur-3xl" animate={{
        scale: [1.1, 1, 1.1],
        x: [0, -20, 0],
        opacity: [0.3, 0.5, 0.3]
      }} transition={{
                  ...
                  duration: 0.6
                    ...
                    <div className="flex items-center justify-between mb-5 sm:mb-8 pb-4 sm:pb-6 border-b border-primary/10">
                      <div className="flex items-center gap-2 sm:gap-4">
                        <motion.div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-primary via-orange-500 to-amber-400 flex items-center justify-center shadow-lg" animate={{
                        rotate: [0, 5, -5, 0]
                      }} transition={{
                        duration: 6,
                        repeat: Infinity,
                    ...
                    <motion.div className="bg-gradient-to-r from-primary/10 via-amber-50 to-primary/10 rounded-lg sm:rounded-2xl p-3 sm:p-5 border border-primary/20" initial={{
                    opacity: 0,
                    y: 20
                  }} animate={{
                    opacity: 1,
      ...
      <section className="relative py-14 md:py-20 lg:py-28 overflow-hidden">
        ...
        <motion.div className="absolute top-10 md:top-20 left-[5%] md:left-[10%] w-32 md:w-48 h-32 md:h-48 rounded-full bg-gradient-to-br from-primary/10 to-transparent blur-2xl md:blur-3xl" animate={{
        scale: [1, 1.2, 1],
        opacity: [0.3, 0.5, 0.3]
      }} transition={{
        duration: 8,
        ...
        <motion.div className="absolute bottom-10 md:bottom-20 right-[5%] md:right-[15%] w-40 md:w-56 h-40 md:h-56 rounded-full bg-gradient-to-tl from-amber-400/10 to-transparent blur-2xl md:blur-3xl" animate={{
        scale: [1.1, 1, 1.1],
        opacity: [0.4, 0.6, 0.4]
      }} transition={{
        duration: 10,
