              ...
              <div className="w-full max-w-[600px] lg:max-w-none aspect-square">
                <svg className="w-full h-full opacity-60" viewBox="0 0 500 500" fill="none">
                  ...
                  <rect
                    ...
                    opacity="0.95"
                  />
                  <text x="125" y="115" textAnchor="middle" fill="hsl(21 90% 48%)" fontSize="14" fontWeight="600">
                    AI
                  </text>
                  ...
                  <rect
                    ...
                    opacity="0.95"
                  />
                  <text x="375" y="95" textAnchor="middle" fill="hsl(21 90% 48%)" fontSize="14" fontWeight="600">
                    SEO
                  </text>
                  ...
                  <rect
                    ...
                    opacity="0.95"
                  />
                  <text x="395" y="395" textAnchor="middle" fill="hsl(21 90% 48%)" fontSize="14" fontWeight="600">
                    ADS
                  </text>
                  ...
                  <rect
                    ...
                    opacity="0.95"
                  />
                  <text x="110" y="375" textAnchor="middle" fill="hsl(21 90% 48%)" fontSize="12" fontWeight="600">
                    AUTO
                  </text>
                  ...
                  <text x="52" y="203" textAnchor="middle" fill="hsl(21 90% 48%)" fontSize="12" fontWeight="600">
                    +127%
                  </text>

                  <rect x="415" y="220" width="65" height="35" rx="6" fill="hsl(40 20% 98%)" opacity="0.9" />
                  <text x="447" y="243" textAnchor="middle" fill="hsl(21 90% 48%)" fontSize="12" fontWeight="600">
                    98.5%
                  </text>
