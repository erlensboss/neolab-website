...
export default function PersonasDatuApstrade() {
  ...
  return (
    <>
      <SEOHead
        titleLv="Personas datu apstrāde | NEOLab"
        titleEn="Personal Data Processing | NEOLab"
        descriptionLv="Informācija par personas datu apstrādi NEOLab vietnē."
        descriptionEn="Information about personal data processing on NEOLab website."
      />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="leading-relaxed">
                {t(
                  `Atbilstoši Eiropas Parlamenta un Padomes Regulai 2016/679, uzņēmums SIA "Grandem Group" (E-pasts info@grandem.lv Tel.: +371 26009276) saņem, 2 gadus uzglabā un apstrādā manis nodotos personas datus (E-pasts, vārdu, uzvārdu un tālruņa numuru), ar mērķi nodrošināt saziņu, sniegt pilnvērtīgāku saturu un atbilstošākas reklāmas.`,
                  `In accordance with Regulation 2016/679 of the European Parliament and of the Council, the company SIA "Grandem Group" (E-mail info@grandem.lv Tel.: +371 26009276) receives, stores for 2 years and processes my personal data (E-mail, first name, last name and phone number), with the purpose of ensuring communication, providing more complete content and more relevant advertising.`
                )}
              </p>
              ...
              <p className="leading-relaxed mt-6">
                {t(
                  ...
                  "By agreeing to data processing, I am informed that my personal data will not be sent to other EU companies, or to a third country, or to an international organization."
                )}
              </p>
              ...
              <p className="leading-relaxed mt-6">
                {t(
                  ...
                  "I acknowledge my rights regarding the deletion, correction, restriction of processing of my personal data, etc."
                )}
              </p>
