  ...
  return (
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative overflow-hidden py-12 md:py-16">
        ...
        <motion.div
          className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] rounded-full bg-gradient-to-br from-primary/8 to-amber-200/5 blur-3xl"
          animate={{
            scale: [1, 1.05, 1],
            opacity: [0.5, 0.7, 0.5],
          }}
        ...
        <div className="container-neo relative z-10">
          ...
          <ScrollReveal className="max-w-3xl mb-8 md:mb-20">
            <span className="chip mb-3 md:mb-4 inline-block text-xs md:text-sm">
              {t("Jūsu situācija", "Your situation")}
            </span>
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6">
              {t("Kādiem uzņēmumiem maksas reklāma ir vajadzīga?", "Which businesses need paid advertising?")}
            </h2>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              {t(
                "Maksas reklāma vislabāk strādā uzņēmumiem, kuri zina, ko piedāvā, un vēlas redzēt atdevi no reklāmas budžeta.",
                "Paid advertising works best for businesses that know what they offer and want to see return on their ad budget.",
              )}
            </p>
          </ScrollReveal>
                ...
                <div className="rounded-xl md:rounded-2xl bg-card border border-border p-5 md:p-10 shadow-sm">
                  ...
                  <div className="space-y-3 md:space-y-5">
                    {[
                      {
                        text: t(
                          "Uzņēmumam ir konkrēts pakalpojums vai produkts",
                          "The business has a specific service or product",
                        ),
                        icon: Target,
                      },
                      {
                      ...
                      {
                        text: t(
                          "Tirgū jau notiek aktīva meklēšana vai interese",
                          "Active searching or interest already exists in the market",
                        ),
                        icon: Eye,
                      },
                      {
                        text: t(
                          "Ir vēlme testēt jaunu piedāvājumu vai virzienu",
                          "Want to test a new offer or direction",
                        ),
                        icon: Activity,
                      },
                      {
                        text: t(
                          "Ir noteikts un kontrolējams reklāmas budžets",
                          "There is a defined and controllable ad budget",
                        ),
                        icon: DollarSign,
                      },
                    ].map((item, idx) => (
                      ...
                      >
                        ...
                        <span className="text-sm md:text-base text-foreground font-medium pt-1 md:pt-2">
                          {item.text}
                        </span>
                      </motion.div>
                    ))}
            ...
            <div className="lg:col-span-5 flex flex-col gap-4 md:gap-6">
              ...
              <ScrollReveal delay={0.2}>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <h3 className="text-base md:text-xl font-semibold mb-4 md:mb-5">
                      {t("Īpaši efektīva maksas reklāma:", "Paid advertising is especially effective for:")}
                    </h3>
                    ...
                    <div className="grid grid-cols-2 gap-2 md:gap-3">
                      {[
                        ...
                        >
                          <span className="font-medium text-foreground my-0 py-0 text-center text-xs md:text-base">
                            {segment.label}
                          </span>
                        </motion.div>
                      ))}
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-5">
                      ...
                      <span className="text-xs md:text-sm font-medium text-muted-foreground">
                        {t("Atpazīstat sevi?", "Recognize yourself?")}
                      </span>
                    </div>

                    <p className="text-sm md:text-base text-foreground mb-4 md:mb-6 flex-1">
                      {t(
                        "Ja kaut viens no šiem punktiem atbilst jūsu situācijai, tad maksas reklāma var būt pareizais solis.",
                        "If even one of these points matches your situation, then paid advertising could be the right step.",
                      )}
                    </p>
