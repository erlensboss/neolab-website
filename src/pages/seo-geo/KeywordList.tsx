...
import { Target, ArrowRight, ArrowLeft, CheckCircle2, Search, TrendingUp, ListChecks, Filter } from "lucide-react";
            ...
            <div className="max-w-4xl">
              ...
              <ScrollReveal delay={0.1}>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-foreground">
                  Keyword list{" "}
                  <span className="text-gradient-orange">veidošana</span>
                </h1>
              </ScrollReveal>
        ...
        <section className="relative py-16 md:py-24 overflow-hidden">
          ...
          <div className="container-neo relative z-10">
            <ScrollReveal>
              <div className="text-center mb-12 md:mb-16">
                <h2 className="text-foreground mb-4">
                  {language === "lv" ? "Ko ietver keyword" : "What Keyword"}
                  <span className="text-gradient-orange"> list izstrāde</span>
                </h2>
              </div>
            </ScrollReveal>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Search, title: language === "lv" ? "Atslēgvārdu izpēte" : "Keyword Research", description: language === "lv" ? "Padziļināta atslēgvārdu un meklējumu analīze" : "In-depth keyword and search query analysis" },
                { icon: Filter, title: language === "lv" ? "Nolūku grupēšana" : "Intent Grouping", description: language === "lv" ? "Atslēgvārdu sadalīšana pa meklēšanas nolūkiem" : "Keyword division by search intents" },
                { icon: ListChecks, title: language === "lv" ? "Lapu piešķiršana" : "Page Assignment", description: language === "lv" ? "Katra atslēgvārda piesaiste konkrētai lapai" : "Each keyword assigned to a specific page" },
                { icon: TrendingUp, title: language === "lv" ? "Prioritizācija" : "Prioritization", description: language === "lv" ? "Atslēgvārdu ranžēšana pēc potenciāla un grūtības" : "Keyword ranking by potential and difficulty" },
              ].map((item, index) => (
                <ScrollReveal key={item.title} delay={0.1 + index * 0.1}>
                  ...
                  >
                    <motion.div
                      className="w-12 h-12 rounded-xl bg-gradient-to-br from-yellow-500 to-amber-400 flex items-center justify-center mb-4 shadow-md"
          ...
          <div className="container-neo relative z-10">
            <ScrollReveal>
              <div className="relative bg-gradient-to-br from-white via-white to-orange-50/50 rounded-2xl md:rounded-3xl p-8 md:p-12 border border-primary/10 shadow-xl text-center">
                <motion.div 
                  className="w-16 h-16 rounded-2xl bg-gradient-to-br from-yellow-500 to-amber-400 flex items-center justify-center mx-auto mb-6 shadow-lg"
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                  {language === "lv" ? "Gatavi izveidot savu atslēgvārdu stratēģiju?" : "Ready to build your keyword strategy?"}
                </h3>
