...
export default function Sikdatnes() {
  ...
  return (
    <>
      <SEOHead
        titleLv="Sīkdatnes | NEOLab"
        titleEn="Cookies | NEOLab"
        descriptionLv="Informācija par sīkdatņu izmantošanu NEOLab vietnē."
        descriptionEn="Information about cookie usage on NEOLab website."
      />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
              ...
              <section>
                ...
                <p className="mb-4">
                  {t(
                    "NEOLab izmanto Google Analytics pakalpojumus, padarot pieejamu informāciju par pakalpojumiem meklēšanas tīmeklī, minētais pakalpojums paredz sīkdatņu saglabāšanu Jūsu ierīcē.",
                    "NEOLab uses Google Analytics services, making information about search web services available, this service provides for storing cookies on your device."
                  )}
                </p>
                <p className="mb-4">
                  {t(
                ...
                <p className="mb-4">
                  {t(
                    ...
                    "Google confirms that its data processing, including data transfer to third parties, complies with the requirements of European Union and US regulations, and separately notes that the received data is not used for providing Google services."
                  )}
                </p>
                <p>
                  {t(
                    "Jūs varat novērst sīkdatņu nodošanu Google, izmantojot spraudni ",
                    "You can prevent the transfer of cookies to Google by using the plugin "
                  )}
                  <a
              ...
              <section>
                ...
                <p className="mb-4">
                  {t(
                    ...
                    "You have the option to delete cookies from your computer or other device, as well as use the settings offered by most browsers that prevent the creation of cookies."
                  )}
                </p>
                <p className="mb-4">
                  {t(
                    "Praktiski visas pārlūkprogrammas paredz iespēju:",
                    "Practically all browsers provide the ability to:"
                  )}
                </p>
