    ...
    <div className="overflow-hidden">
        ...
        <div className="container-neo section-padding relative z-10 flex items-center justify-center min-h-[95vh]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <ScrollReveal delay={0.2}>
              ...
              >
                Vide, kur mākslīgais intelekts tiek nevis teorētiski apspriests, bet praktiski pētīts, testēts un
                izmantots reālos scenārijos.{" "}
              </p>
            </ScrollReveal>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <ScrollReveal delay={0.2}>
                ...
                >
                  AI Lab ir NEOLab veidota attīstības un eksperimentu vide, kas fokusējas uz mākslīgā intelekta
                  praktisku izpēti, veidošanu un pielietošanu.
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                ...
                >
                  Tā ir vieta, kur jaunieši ar interesi par tehnoloģijām strādā ar reāliem rīkiem, reāliem scenārijiem
                  un reālām problēmām. Attīstoties prasmēs, spējās un domāšanā, šeit top AI un tehnoloģiju risinājumi,
                  kuriem ir praktiska vērtība.
                </p>
              </ScrollReveal>
              ...
              <div className="relative flex items-center justify-center py-12">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      boxShadow:
                        "0 0 60px hsla(0, 0%, 100%, 0.3), 0 0 120px hsla(21, 90%, 50%, 0.2), inset 0 -4px 20px hsla(0, 0%, 0%, 0.1)",
                    }}
                  >
          ...
          <ScrollReveal delay={0.5}>
            <div className="max-w-2xl mx-auto text-center">
              ...
              >
                ...
                >
                  Fokusējamies uz izpratni un izaugsmi.
                </p>
              </div>
            </div>
          </ScrollReveal>
      ...
      >
        ...
        <div className="container-neo section-padding relative z-10">
          ...
          <ScrollReveal className="text-center mb-16">
            <div
              className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full border border-white/30 bg-white/15 backdrop-blur-md mb-6"
              style={{
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5">
              <ScrollReveal delay={0.1}>
                <div
                  className="relative p-8 rounded-3xl border border-white/20 bg-white/10 backdrop-blur-md"
                  style={{
                ...
                >
                  ...
                  <p
                    className="text-lg text-white/95 leading-relaxed font-medium"
                    style={{
                      textShadow: "0 2px 12px hsla(0, 0%, 0%, 0.2)",
                    }}
                  >
                    Latvijā un plašākā reģionā trūkst vietu, kur jaunieši var droši un atbildīgi attīstīt savas
                    tehnoloģiju prasmes ar mākslīgo intelektu.
                  </p>
                </div>
              </ScrollReveal>
            </div>
                  ...
                  <ScrollReveal key={index} delay={item.delay}>
                    ...
                    >
                      ...
                      <div className="relative flex items-start gap-4">
                        ...
                        <p
                          className="text-white font-medium leading-relaxed pt-1"
                          style={{
          ...
          <ScrollReveal delay={0.4}>
            <div className="mt-16 max-w-3xl mx-auto">
              <div
                className="relative text-center p-8 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md"
                style={{
              ...
              >
                ...
                <p
                  className="text-base text-white/70 mt-3 italic"
                  style={{
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <ScrollReveal delay={0.2}>
              <p className="text-lg text-muted-foreground mb-8">
                Ja tevi interesē mākslīgais intelekts, tehnoloģijas un digitālā domāšana, seko līdzi NEOLab attīstībai
