                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 lg:p-16 border border-white/60 shadow-xl" style={{
                  ...
                  <div className="mb-8 p-6 rounded-xl bg-gradient-to-br from-primary/5 via-orange-50/50 to-amber-50/30 border border-primary/10">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="text-xs uppercase tracking-[0.15em] text-primary font-semibold">Etimoloģija</span>
                      <div className="flex-1 h-px bg-gradient-to-r from-primary/20 to-transparent" />
                    </div>
                    <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                      No sengrieķu <span className="font-medium text-foreground">νέος</span> (<span className="italic">néos</span>, "jauns, jaundzimis"). 
                      <span className="ml-2 px-2 py-0.5 rounded bg-primary/10 text-primary text-sm font-medium">Prefikss: neo-</span>
                    </p>
                  </div>
