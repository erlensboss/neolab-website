...
const storyBlocks = (t: (lv: string, en: string) => string) => [{
  ...
  content: t("NEOLab ir mākslīgā intelekta laboratorija, kurā attīstām jaunus AI risinājumus dažādām uzņēmumu vajadzībām - sākot ar praktiskiem digitāliem risinājumiem un beidzot ar nestandarta idejām, kas praksē izrādās pārsteidzoši efektīvas.", "NEOLab is an artificial intelligence laboratory where we develop new AI solutions for various business needs - from practical digital solutions to unconventional ideas that prove surprisingly effective in practice."),
  ...
  content: t("NEOLab veido jaunu ekspertu komanda ar dabīgu izpratni par mākslīgā intelekta tehnoloģiju pārvaldību un izstrādi. Mēs esam tehnoloģiju un algoritmu paaudze, kas digitālajā vidē orientējas intuitīvi, ātri apgūst jauno un spēj pielāgoties straujām pārmaiņām.", "NEOLab is formed by a team of young experts with a natural understanding of AI technology management and development. We are a generation of technologies and algorithms that navigate the digital environment intuitively, learn new things quickly, and can adapt to rapid changes."),
  ...
  content: t("Jaunība mums nav tikai vecums. Tā ir degsme, zinātkāre un nepārtraukts izsalkums pēc attīstības. Mēs esam uzauguši digitālajā pasaulē, un jaunākās tehnoloģijas mums ir dabiska ikdienas sastāvdaļa.", "Youth for us is not just an age. It is passion, curiosity, and a continuous hunger for development. We have grown up in the digital world, and the latest technologies are a natural part of our daily lives."),
...
function StoryBlock({
  ...
  return <motion.div ref={ref} initial={{
    ...
    y: -8
      ...
      {/* Card */}
      <div className="group relative bg-white rounded-3xl p-8 md:p-10 border border-border/40 overflow-hidden transition-all duration-500 hover:border-primary/30 cursor-pointer" style={{
      boxShadow: `0 20px 60px -20px ${block.bgGlow}, 0 8px 24px -12px hsl(0 0% 0% / 0.08)`
        ...
        {/* Corner glow */}
        <div className={`absolute ${isRight ? "top-0 left-0" : "top-0 right-0"} w-40 h-40 rounded-full blur-3xl opacity-40 group-hover:opacity-70 transition-opacity duration-500`} style={{
        background: block.bgGlow
      }} />

        {/* Decorative gradient line */}
        <div className={`absolute ${isRight ? "left-0" : "right-0"} top-8 bottom-8 w-1 rounded-full bg-gradient-to-b ${block.gradient} opacity-60 group-hover:opacity-100 transition-opacity duration-300`} />
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            type: "spring",
            stiffness: 300
          }} className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${block.gradient} flex items-center justify-center shadow-lg`} style={{
    ...
    <div className="overflow-hidden">
            ...
            <div className="lg:col-span-6 order-1 lg:order-1">
              ...
              <ScrollReveal delay={0.2}>
                <p className="text-lg md:text-2xl lg:text-[1.7rem] text-muted-foreground leading-relaxed max-w-2xl">
                  {t("NEOLab ir vieta, kur digitālā attīstība tiek veidota apzināti, ar izpratni un skatu uz nākotni.", "NEOLab is a place where digital development is shaped consciously, with understanding and a look towards the future.")}
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                <div className="flex flex-wrap gap-4 md:gap-6 mt-8 md:mt-12">
                  {[t("Profesionāla pieeja", "Professional approach"), t("Pielāgoti risinājumi", "Custom solutions"), t("Ilgtermiņa partnerība", "Long-term partnership")].map((text, i) => <div key={i} className="flex items-center gap-2 md:gap-3 text-sm md:text-base text-foreground/80">
              ...
              <ScrollReveal delay={0.15} direction="right">
                <div className="relative w-[220px] h-[220px] sm:w-[320px] sm:h-[320px] md:w-[400px] md:h-[400px] lg:w-[480px] lg:h-[480px]">
                  ...
                  transformOrigin: "center center"
                    ...
                    repeat: Infinity,
                    delay: i * 0.3
                  }} className="absolute rounded-full bg-gradient-to-br from-primary to-orange-400" style={{
        ...
        <div className="container-neo section-padding relative z-10">
          ...
          <div className="max-w-5xl mx-auto relative">
            ...
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 -translate-x-1/2 w-px">
              ...
              repeat: Infinity,
              ease: "linear"
            }} className="absolute left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-primary shadow-lg" style={{
            ...
            <div className="flex flex-col gap-12 md:gap-0">
              ...
              const isRight = block.position === "right";
              return <div key={block.title} className="relative md:grid md:grid-cols-[1fr_auto_1fr] md:gap-8 items-center">
                    ...
                    stiffness: 200,
                    delay: index * 0.1
                  }} className={`w-5 h-5 rounded-full bg-gradient-to-br ${block.gradient} border-4 border-white shadow-lg`} style={{
                    boxShadow: `0 0 20px ${block.bgGlow}`
                  }} />
                    </div>
          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              <div className="relative">
                ...
                boxShadow: "0 25px 80px -20px hsl(25 60% 50% / 0.15), 0 0 0 1px hsl(25 60% 90% / 0.5)"
                  ...
                  <div className="flex flex-col md:flex-row md:items-end gap-4 md:gap-6 mb-8 pb-6 border-b border-border/50">
                    <div className="flex items-baseline gap-3 flex-wrap">
                      <motion.h2 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight" style={{
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                          {t("Tas simbolizē gan jaunākās digitālās un mākslīgā intelekta tehnoloģijas, gan mūsu attieksmi, enerģiju, maksimālismu un gatavību pielāgoties digitālās pasaules pārmaiņām.", "It symbolizes both the latest digital and artificial intelligence technologies and our attitude, energy, maximalism, and readiness to adapt to the changes of the digital world.")}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Paradigm statement */}
                  <motion.div className="mt-10 pt-8 border-t border-border/50" initial={{
                  opacity: 0
                }} whileInView={{
                  opacity: 1
                }} transition={{
                ...
                repeat: Infinity,
                ease: "easeInOut"
              }} className="absolute -top-4 -right-4 md:-right-8 w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-orange-400 to-amber-500 shadow-xl flex items-center justify-center p-3 md:p-4" style={{
                ...
                ease: "easeInOut",
                delay: 1
              }} className="absolute -bottom-3 -left-3 md:-left-6 w-12 h-12 md:w-16 md:h-16 rounded-xl bg-gradient-to-br from-rose-400 to-orange-400 shadow-lg flex items-center justify-center" style={{
        ...
        <div className="container-neo relative z-10">
          ...
          <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 max-w-7xl mx-auto">
            ...
            <ScrollReveal delay={0.1} className="lg:col-span-5 lg:row-span-2">
              ...
              duration: 0.4,
              ease: "easeOut"
            }} className="relative h-full rounded-3xl overflow-hidden group p-8 md:p-10 flex flex-col" style={{
              ...
              boxShadow: "0 25px 60px -15px hsl(25 70% 50% / 0.18), 0 0 0 1px hsl(25 50% 90% / 0.6), inset 0 1px 0 hsl(0 0% 100% / 0.8)"
                ...
                repeat: Infinity,
                ease: "easeInOut"
              }} className="absolute top-8 right-8 w-48 h-48 rounded-full blur-3xl pointer-events-none" style={{
                ...
                repeat: Infinity,
                ease: "easeInOut"
              }} className="absolute top-8 right-8 w-16 h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center shadow-xl z-10" style={{
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-5">
                    {t("Palīdzēt uzņēmumiem izmantot tehnoloģijas tā, lai tās paātrina ikdienišķus procesus.", "To help companies use technology so that it accelerates daily processes.")}
                  </p>

                  <div className="p-4 rounded-xl bg-white/60 backdrop-blur-sm border border-white/80">
                    <p className="text-sm text-muted-foreground italic">
                      "
                      {t("Tehnoloģijām ir jāatvieglo darbs, jāsniedz skaidrība un jāpalīdz augt, nevis jārada sarežģītība.", "Technology must facilitate work, provide clarity, and help grow, not create complexity.")}
                      "
                    </p>
                  </div>
                </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 lg:gap-8">
              ...
              <ScrollReveal delay={0.2}>
                ...
                duration: 0.4,
                ease: "easeOut"
              }} className="relative rounded-3xl overflow-hidden group" style={{
                ...
                boxShadow: "0 20px 50px -15px hsl(350 50% 50% / 0.12), 0 0 0 1px hsl(350 40% 92% / 0.6), inset 0 1px 0 hsl(0 0% 100% / 0.8)"
                  ...
                  repeat: Infinity,
                  ease: "easeInOut"
                }} className="absolute top-0 left-1/3 w-64 h-40 rounded-full blur-3xl" style={{
                    ...
                    <div className="flex items-start justify-between gap-6">
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          {t("Veidot vidi, kur mākslīgais intelekts tiek izmantots ar skatu tālāk par šodienas vajadzībām, fokusējoties uz risinājumiem nākotnei.", "To create an environment where AI is used with a look beyond today's needs, focusing on solutions for the future.")}
                        </p>
                      </div>
                      ...
                      <div className="hidden md:block flex-shrink-0">
                        <div className="relative w-28 h-28">
                          ...
                          repeat: Infinity,
                          ease: "linear"
                        }} className="absolute inset-3 rounded-full border" style={{
              ...
              <ScrollReveal delay={0.3}>
                ...
                boxShadow: "0 20px 50px -15px hsl(40 60% 50% / 0.15), 0 0 0 1px hsl(40 50% 90% / 0.6), inset 0 1px 0 hsl(0 0% 100% / 0.8)"
                  ...
                  repeat: Infinity,
                  ease: "easeInOut"
                }} className="absolute bottom-0 right-1/4 w-56 h-40 rounded-full blur-3xl" style={{
                  ...
                  <div className="p-8 md:p-10">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      desc: t("Katrs risinājums ir veidots ar apziņu par tā ietekmi.", "Every solution is made with an awareness of its impact."),
                      accent: "hsl(40 70% 45%)"
                    }, {
                    ...
                    }].map((value, i) => <motion.div key={value.title} initial={{
                      opacity: 0,
                      y: 20
                    }} whileInView={{
                      opacity: 1,
      ...
      background: "linear-gradient(180deg, hsl(30 50% 97%) 0%, hsl(35 40% 96%) 100%)"
        ...
        <div className="container-neo px-6">
          <ScrollReveal>
            <div className="max-w-4xl mx-auto rounded-2xl p-8 md:p-10 relative overflow-hidden" style={{
              ...
              <div className="flex flex-col md:flex-row md:items-start gap-8">
                ...
                <div className="md:w-2/3 flex-1">
                  ...
                  <p className="mt-6 text-sm text-muted-foreground italic pl-1 border-l-2 border-primary/30">
                    {t("Katrs risinājums ir veidots, ņemot vērā uzņēmuma mērķus un šī brīža situāciju.", "Every solution is designed with your company's goals and current situation in mind.")}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container-neo px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            <ScrollReveal>
              ...
              boxShadow: "0 25px 60px -15px hsl(25 50% 50% / 0.12), 0 0 0 1px hsl(25 40% 90% / 0.6), inset 0 1px 0 hsl(0 0% 100% / 0.9)"
            }} whileHover={{
              boxShadow: "0 30px 70px -15px hsl(25 50% 50% / 0.18), 0 0 0 1px hsl(25 60% 80% / 0.5), inset 0 1px 0 hsl(0 0% 100%)",
              y: -4
            }} transition={{
              duration: 0.4,
              ease: "easeOut"
                ...
                <div className="max-w-2xl">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
                    ...
                    <span className="text-sm font-medium text-primary">{t("AI Lab", "AI Lab")}</span>
                  </div>
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4">
                    {t("NEOLab darbības pamatā ir AI Lab – iekšējā attīstības vide, kur tiek pētītas un testētas jaunākās tehnoloģijas.", "NEOLab's operations are based on AI Lab – an internal development environment where the latest technologies are researched and tested.")}
                  </p>

                  <p className="text-base text-muted-foreground/80 leading-relaxed mb-8 md:text-xl">
                    {t("Tas ļauj mums strādāt ar pārbaudītām pieejām un neveidot klientu projektus kā eksperimentus.", "This allows us to work with proven approaches and not create client projects as experiments.")}
                  </p>
                ...
                <div className="absolute bottom-0 right-0 w-64 h-64 rounded-full blur-3xl opacity-30 pointer-events-none" style={{
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <ScrollReveal delay={0.1}>
              <p className="text-muted-foreground text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
                {t("Līdzīgi ir ar tehnoloģijām. Ja meklē jaunākus, efektīvākus un jēgpilnus mākslīgā intelekta un digitālos risinājumus, strādā ar NEOLab.", "It's similar with technology. If you are looking for younger, more efficient, and meaningful AI and digital solutions, work with NEOLab.")}
              </p>
            </ScrollReveal>
