            ...
            <div className="max-w-2xl">
              ...
              <ScrollReveal delay={0.1}>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 md:mb-6 text-foreground">
                  {t("SEO un GEO optimizācija", "SEO and GEO optimization")}{" "}
                  <span className="text-gradient-orange">{t("uzņēmumiem", "for businesses")}</span>
                </h1>
              </ScrollReveal>
                  ...
                  <div className="flex items-center justify-between mb-5 md:mb-8">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-semibold text-sm md:text-base text-foreground">
                        {t("Redzamības sistēma", "Visibility system")}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs md:text-sm font-medium text-green-700">
                          {t("Sistēmiska izaugsme", "Systematic growth")}
                        </span>
                      </div>
            ...
            >
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border border-primary/20 text-center">
                ...
                <p className="text-lg md:text-xl lg:text-2xl text-foreground font-medium leading-relaxed">
                  ...
                  <span className="text-amber-600 font-semibold">{t("nākotnes", "tomorrow's")}</span>{" "}
                  {t("meklēšanas vidēs.", "search environments.")}
                </p>
              </div>
            </motion.div>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="text-center mb-14 md:mb-20">
              ...
              <h2 className="text-foreground max-w-4xl mx-auto leading-tight">
                <span className="text-gradient-orange">SEO</span> {t("un", "and")}{" "}
                <span className="text-gradient-orange">GEO</span>{" "}
                {t("nav viens rezultāts, tā ir", "is not one result, it's a")}{" "}
                <span className="text-gradient-orange">{t("sistēma", "system")}</span>{" "}
                {t("uzņēmuma labā.", "for your business.")}
              </h2>
            </div>
          </ScrollReveal>
            ...
            {[
              {
                ...
                description: t(
                  ...
                  "The business becomes discoverable when potential clients are actively searching for solutions, not just seeing ads.",
                ),
              ...
              },
              {
                ...
                description: t(
                  ...
                  "Website logic, content, and technical quality are improved, affecting both user experience and search engine perception.",
                ),
              ...
              },
              {
                ...
                description: t(
                  ...
                  "The business understands which queries attract visitors, how they reach the offer, and where real results come from.",
                ),
              ...
              },
              {
                ...
                description: t(
                  ...
                  "GEO optimization expands presence in next-generation search platforms and AI-generated responses.",
                ),
              ...
              },
              {
                ...
                description: t(
                  ...
                  "SEO and GEO become a stable foundation for digital growth, not a tactical tool for individual campaigns.",
                ),
        ...
        <div className="container-neo relative z-10">
          ...
          <ScrollReveal>
            <div className="text-center mb-14 md:mb-20">
              ...
              <h2 className="text-foreground max-w-3xl mx-auto">
                {t("Mūsu", "Our")} <span className="text-gradient-orange">{t("pieredze", "experience")}</span>{" "}
                {t("un sasniegumi", "and achievements")}
              </h2>
            </div>
          </ScrollReveal>
            ...
            {[
              {
                ...
                situation: t(
                  ...
                  "An online store with more than 2000 products was not found in Google searches. Product pages were not indexed, and organic traffic was minimal.",
                ),
                solution: t(
                  ...
                  "We performed a full SEO audit, organized the site structure, optimized product pages with structured data, and created a clear categorization strategy.",
                ),
                result: "+340%",
              ...
              },
              {
                ...
                situation: t(
                  ...
                  "A construction company was not found in local searches. Clients couldn't find the company when searching for the service with the city name.",
                ),
                solution: t(
                  ...
                  "During the SEO audit, we identified problems with local visibility, optimized Google profile, organized NAP data, and created a local content structure.",
                ),
                result: "Top 3",
              ...
              },
              {
                ...
                situation: t(
                  ...
                  "A consulting company received visitors but few inquiries. High bounce rate and unclear conversion flow.",
                ),
                solution: t(
                  "Balstoties audita secinājumos, pārstrukturējām saturu, uzlabojām galvenās lapas un izveidojām skaidru konversijas piltuvi.",
                  "Based on audit findings, we restructured content, improved key pages, and created a clear conversion funnel.",
                ),
                result: "+180%",
              ...
              <ScrollReveal key={index} delay={caseStudy.delay}>
                <motion.div
                  whileHover={{
                    y: -8,
                    scale: 1.02,
            ...
            <div className="mt-16 flex justify-center">
              ...
              >
                ...
                <span className="text-muted-foreground font-medium">
                  {t("Jūsu veiksmes stāsts var būt nākamais", "Your success story could be next")}
                </span>
              </motion.div>
            </div>
          </ScrollReveal>
            ...
            <div className="text-center mb-16 md:mb-20">
              ...
              >
                ...
                <span className="text-sm font-semibold text-primary uppercase tracking-widest">
                  {t("Metodika", "Methodology")}
                </span>
                <div className="w-8 h-[2px] bg-gradient-to-l from-transparent to-primary" />
              </motion.div>
              <h2 className="text-foreground max-w-4xl mx-auto mb-6">
                {t("Kāds ir", "What is the")} <span className="text-gradient-orange">NEOLab</span>{" "}
                {t("risinājums", "solution")}
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                {t(
                  "NEOLab piedāvā strukturētu un pārskatāmu pieeju SEO un GEO optimizācijai, kas balstīta auditos, prioritātēs un pakāpeniskā ieviešanā.",
                  "NEOLab offers a structured and transparent approach to SEO and GEO optimization, based on audits, priorities, and gradual implementation.",
                )}
              </p>
            </div>
          </ScrollReveal>
                      ...
                      <div className="lg:col-span-3">
                        ...
                        >
                          ...
                          <span className="text-sm font-semibold text-primary">
                            {t("Galvenais pakalpojums", "Main service")}
                          </span>
                        </motion.div>
                        ...
                        <p className="text-muted-foreground text-base md:text-lg leading-relaxed mb-6 max-w-2xl">
                          {t(
                            ...
                            "Collaboration always starts with an audit. The website's technical side, content, structure, competitors, and existing visibility are analyzed to understand where the main growth opportunities lie.",
                          )}
                        </p>
                        ...
                        <div className="grid sm:grid-cols-2 gap-3 mb-6">
                          {[
                            t("Pilna tehniskā analīze", "Full technical analysis"),
                            t("Konkurentu izpēte", "Competitor research"),
                            t("On-Page SEO pārskats", "On-Page SEO Overview"),
                            t("Backlink apskate", "Backlink overview"),
                          ].map((feature, i) => (
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="mt-5 pt-4 border-t border-primary/10 flex items-center justify-between">
                              <span className="text-sm text-muted-foreground">
                                {t("Kopējais vērtējums", "Overall score")}
                              </span>
                              <motion.span
                ...
                <div className="relative flex flex-col lg:flex-row items-center justify-between gap-5 md:gap-8">
                  <div className="text-center lg:text-left">
                    <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-foreground mb-2 md:mb-3">
                      {t("Katrs solis tiek pielāgots", "Every step is tailored to")}{" "}
                      <span className="text-gradient-orange">{t("Jūsu situācijai", "your situation")}</span>
                    </h3>
                    <p className="text-muted-foreground text-base md:text-lg max-w-xl">
                      {t(
                        "Saņemiet bezmaksas konsultāciju, lai saprastu, kādi soļi ir būtiskākie tieši jūsu uzņēmumam.",
                        "Get a free consultation to understand which steps are most important for your business.",
                      )}
                    </p>
                  </div>
        ...
        <div className="container-neo relative z-10">
          ...
          <ScrollReveal>
            <div className="text-center mb-16 md:mb-20">
              ...
              <h2 className="text-foreground max-w-3xl mx-auto">
                {t("Kā notiek", "How does")}{" "}
                <span className="text-gradient-orange">{t("sadarbība", "collaboration")}</span> {t("", "work")}
              </h2>
            </div>
          </ScrollReveal>
            ...
            {[
              {
                ...
                description: t(
                  ...
                  "Collaboration begins with website, existing visibility, and competitor analysis to determine the current situation and main opportunities.",
                ),
                gradient: "from-primary to-orange-500",
                delay: 0.1,
              },
              {
                ...
                description: t(
                  ...
                  "Priorities are set and an individual SEO/GEO strategy is developed that matches the company's goals and resources.",
                ),
                gradient: "from-orange-500 to-amber-500",
                delay: 0.2,
              },
              {
                ...
                description: t(
                  ...
                  "Optimization work is implemented gradually — technical fixes, content improvements, and structural changes.",
                ),
                gradient: "from-amber-500 to-yellow-500",
                delay: 0.3,
              },
              {
                ...
                description: t(
                  ...
                  "Results are continuously monitored and analyzed using professional tools and clear reports.",
                ),
                gradient: "from-yellow-500 to-amber-400",
                delay: 0.4,
              },
              {
                ...
                description: t(
                  ...
                  "Continuous improvement based on data and results. Strategy is adjusted to market changes.",
                ),
                gradient: "from-amber-400 to-primary",
                delay: 0.5,
              },
            ...
            <ScrollReveal delay={0.7}>
              ...
              >
                <p className="text-lg font-semibold text-foreground">
                  {t("Ilgtermiņa rezultāti", "Long-term results")}
                </p>
                <p className="text-muted-foreground">
                  {t("Stabila un pieaugoša redzamība", "Stable and growing visibility")}
                </p>
              </motion.div>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <h2 className="text-foreground">
                {t("Biežāk uzdotie jautājumi par", "Frequently asked questions about")}{" "}
                <span className="text-gradient-orange">SEO</span> {t("un", "and")}{" "}
              ...
              {[
                {
                  ...
                  answer: t(
                    ...
                    "No. GEO complements SEO and expands visibility in new search environments, but does not replace traditional SEO.",
                  ),
                  gradient: "from-primary to-orange-500",
                },
                {
                  icon: Clock,
                  question: t(
                    "Cik ilgā laikā SEO sāk dot rezultātus?",
                    "How long does it take for SEO to show results?",
                  ),
                  answer: t(
                    "Parasti pirmās izmaiņas ir redzamas dažu mēnešu laikā, bet stabils rezultāts veidojas ilgtermiņā.",
                    "Usually the first changes are visible within a few months, but stable results are formed in the long term.",
                  ),
                  gradient: "from-orange-500 to-amber-500",
                },
                {
                  icon: Users,
                  question: t(
                    "Vai SEO un GEO ir piemērots mazākiem uzņēmumiem?",
                    "Is SEO and GEO suitable for smaller businesses?",
                  ),
                  answer: t(
                    "Jā, ja pieeja ir pielāgota uzņēmuma apjomam, mērķiem un resursiem.",
                    "Yes, if the approach is tailored to the company's size, goals, and resources.",
                  ),
                  gradient: "from-amber-500 to-yellow-500",
                },
                {
                  ...
                  answer: t(
                    ...
                    "Yes. SEO and Google Ads can successfully complement each other, creating a stable demand flow.",
                  ),
                  gradient: "from-yellow-500 to-amber-400",
                },
                {
                  ...
                  answer: t(
                    ...
                    "Collaboration starts with an audit and situation assessment to determine the most suitable action plan.",
                  ),
                  gradient: "from-amber-400 to-primary",
                },
              ].map((faq, index) => (
          ...
          <div className="max-w-3xl mx-auto text-center">
            <ScrollReveal>
              <h2 className="text-foreground mb-6">
                {t("Sper soļus", "Take steps")}{" "}
                <span className="text-gradient-orange">
                  {t("jaunajā digitālajā laikmetā", "in the new digital era")}
                </span>
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={0.1}>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 md:mb-10 leading-relaxed">
                {t(
                  ...
                  "Don't fall behind on digital changes. Find out how your business's digital environment works now and where real growth opportunities lie.",
                )}
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
