...
const diagnosticsSteps = [{
  icon: Layers,
  label: "Tehniskais audits",
  description: "Pilna vietnes analīze"
}, {
  icon: FileText,
  label: "Satura inventārs",
  description: "Kas strādā, kas nē"
}, {
  icon: Target,
  label: "Konkurentu izpēte",
  description: "Tirgus pozicionēšana"
}, {
  icon: BarChart3,
  label: "Ranku analīze",
  description: "Esošās pozīcijas"
}];
const geoFeatures = ["Google My Business optimizācija", "Lokālo atsauksmju stratēģija", "NAP konsistence", "Lokālais satura mārketings", "Ģeogrāfiski mērķētas lapas", "Strukturēti dati lokālajam biznesam"];
              ...
              damping: 20
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 border border-primary/20 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  <div className="flex flex-wrap gap-2 mt-6">
                    {["Google", "Tehnika", "Saturs", "Ilgtermiņš"].map(tag => <span key={tag} className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full font-medium">
                        {tag}
                      </span>)}
                  </div>
                </div>
            ...
            <ScrollReveal delay={0.2}>
              ...
              damping: 20
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 border border-amber-300/30 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  {/* Tags */}
                  <div className="flex flex-wrap gap-2 mt-6">
                    {["AI", "AI meklēšana", "ChatGPT", "Gemini", "Nākotne"].map(tag => <span key={tag} className="px-3 py-1 bg-amber-100 text-amber-700 text-sm rounded-full font-medium">
                        {tag}
                      </span>)}
                  </div>
                </div>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container-neo relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-10 md:mb-16">
            ...
            delay: 0.35
          }].map((service, index) => <ScrollReveal key={service.number} delay={service.delay}>
                <motion.div whileHover={{
              y: -8
            }} transition={{
              type: "spring",
              ...
              damping: 25
                  ...
                  <div className="relative bg-white rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-500 h-full flex flex-col overflow-hidden">
                    {/* Top accent line */}
                    <motion.div className={`h-1 bg-gradient-to-r ${service.accent}`} initial={{
                  scaleX: 0
                }} whileInView={{
                  scaleX: 1
                }} viewport={{
                  ...
                  delay: service.delay
                    ...
                    <div className="p-5 md:p-7 flex-1 flex flex-col">
                      ...
                      <div className="flex items-start justify-between mb-4 md:mb-5">
                        <motion.div className={`w-11 h-11 md:w-14 md:h-14 rounded-xl md:rounded-2xl bg-gradient-to-br ${service.accent} flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow duration-300`} whileHover={{
                      rotate: 5,
                      scale: 1.05
                    }}>
                      ...
                      <div className="mt-4 md:mt-5 pt-3 md:pt-4 border-t border-gray-100">
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                          <motion.div className={`w-2 h-2 rounded-full bg-gradient-to-r ${service.accent}`} animate={{
                        scale: [1, 1.2, 1]
                      }} transition={{
                        duration: 2,
                        repeat: Infinity,
