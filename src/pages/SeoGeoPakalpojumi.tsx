                    ...
                    <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
                      ...
                      <div className="lg:w-64 flex-shrink-0">
                        <div className="bg-muted/50 rounded-xl p-4 border border-border/50 space-y-3">
                          {[
                            { icon: Gauge, label: t("Lapas ātrums", "Page speed") },
                            { icon: Code2, label: t("Indeksācija", "Indexation") },
                            { icon: Wrench, label: t("Kļūdu labošana", "Error fixing") },
                            { icon: Layers, label: t("Struktūra", "Structure") },
                          ].map((item, i) => (
                            <motion.div
                              key={i}
                          ...
                          <div className="relative w-28 h-28">
                            <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                              ...
                              <motion.circle
                                ...
                                whileInView={{ strokeDashoffset: 2 * Math.PI * 40 * 0.35 }}
                                viewport={{ once: true }}
                ...
                <div className="relative bg-card/90 backdrop-blur-sm rounded-2xl md:rounded-3xl border border-border/60 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                  ...
                  <div className="p-6 md:p-8 lg:p-10">
                    <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
                      ...
                      <div className="lg:w-60 flex-shrink-0">
                        <div className="bg-sky-50/60 rounded-xl p-5 border border-sky-200/40">
                          <div className="flex items-end justify-center gap-3 h-28">
                            {[
                              { label: t("Fokuss", "Focus"), h: "h-14", icon: Target },
                              { label: t("Konteksts", "Context"), h: "h-20", icon: BookOpen },
                              { label: t("Autoritāte", "Authority"), h: "h-24", icon: Shield },
                            ].map((item, i) => (
                              <motion.div
                                key={i}
